...
var _Client_instances, _a, _Client_markingPeriods, _Client_terms, _Client_checkForClientReadiness;
...
export default class Client {
    ...
    getStudentInfo() {
        return __awaiter(this, void 0, void 0, function* () {
            __classPrivateFieldGet(this, _Client_instances, "m", _Client_checkForClientReadiness).call(this);
    ...
    getClasses(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.page.select('select[name="termFilter"]', __classPrivateFieldGet(Client, _a, "f", _Client_markingPeriods).get(options.term));
            yield this.page.waitForSelector('#dataGrid');
    ...
    getAssignments(course, assignmentFilter) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.page.select('#gradeTermOid', __classPrivateFieldGet(Client, _a, "f", _Client_markingPeriods).get(assignmentFilter.term));
...
_a = Client, _Client_instances = new WeakSet(), _Client_checkForClientReadiness = function _Client_checkForClientReadiness() {
    if (!this.loggedIn) {
        throw new ClientNotReadyError('Try logging in first, then getting information.');
    }
};
_Client_markingPeriods = { value: new Map()
        .set('q1', 'GTMp1000026Gdh')
        .set('q2', 'GTMp1000026Gdi')
        .set('q3', 'GTMp1000026Gdj')
        .set('q4', 'GTMp1000026Gdk')
        .set('all', 'all') };
_Client_terms = { value: Object.keys(__classPrivateFieldGet(Client, _a, "f", _Client_markingPeriods)) };
